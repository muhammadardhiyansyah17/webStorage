...
const localMaximumAttempField = document.getElementById('local-maximum-attempt-field');
...
const sessionUserAttemptsKey = 'SESSION_USER_ATTEMPS';
...
window.addEventListener('load', function () {
    ...
    localMaximumAttempField.innerText = localStorage.getItem(localMaximumAttemptsKey);
});
...
function checkAnswer(userGuess) {
    ...
    if (userGuess == answer) {
        ...
        afterGameDisplay.removeAttribute('hideen');
